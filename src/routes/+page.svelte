...
<header class="h-screen grid place-items-center">
  <section class="max-w-6xl flex flex-col-reverse md:flex-row gap-12 px-12">
    <div class="flex flex-col gap-6 py-12">
      <h1 class="text-7xl font-bold text-white">Vezsenyi Roland</h1>
      <span class="text-xl text-zinc-500">Üdv! Vezsenyi Roland vagyok, egy elhivatott <b>frontend</b> fejlesztő, aki nagyon kedveli a kihívásokat.</span>
      <a href="https://github.com/VezRoland">
